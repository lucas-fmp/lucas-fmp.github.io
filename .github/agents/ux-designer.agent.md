---
description: "Use when: redesenhar seção visualmente, melhorar estética, ajustar espaçamento, tipografia, paleta de cores, hierarquia visual, UX de componente, layout responsivo, micro-interações, identidade visual do portfolio."
name: "UX Designer"
...
- Paleta: fundos `bg-black`/`bg-gray-800`/`bg-gray-900`, acento `from-cyan-500 to-blue-500`, texto `text-white`/`text-gray-400`
- Fontes: Raleway (corpo), Great Vibes (classe `font-signature`)
- Single-page app com seções: Home, About, Portfolio, Experience, Contact
